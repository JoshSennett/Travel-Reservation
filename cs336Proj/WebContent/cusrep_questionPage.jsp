...
<body>
	...
	<%
		...
		if(rs2.next()){
			...
			<br><br>
			<form style="display:inline-block;" action="checkAnswer.jsp">
				<textarea name="answer_textarea" rows="4" cols="50" maxlength="200"></textarea>
				<span>(Character limit is 200.)</span>
				<br>
				<button class="answerQuestionBtn">Answer this Question</button>
				<input type="text" name="qid" value="<%=qid%>" style="display:none;">
				<input type="text" name="author_ID" value="<%=userID%>" style="display:none;">
			</form>
		<%}
		rs.close();
		statement.close();
